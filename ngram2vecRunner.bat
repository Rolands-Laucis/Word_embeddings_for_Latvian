...
python pairs2sgns.py --pairs_file ..\..\..\Models\Ngram2vec_model\pairs.txt --input_vocab_file ..\..\..\Models\Ngram2vec_model\vocab.input --output_vocab_file ..\..\..\Models\Ngram2vec_model\vocab.output --output_vector_file ..\..\..\Models\Ngram2vec_model\sgns.output --input_vector_file ..\..\..\Models\Ngram2vec_model\sgns.input --size 200