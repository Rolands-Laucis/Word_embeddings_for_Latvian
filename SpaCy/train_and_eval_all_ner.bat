...
python -m spacy evaluate ..\..\Models\Spacy_tagger\ssg_5_200_sg-ner\model-best ..\..\datasets\NER\processed\NER_concatinated-test.spacy --output ../../datasets/NER/ssg_5_200_sg-ner.json --gold-preproc
python -m spacy evaluate ..\..\Models\Spacy_tagger\ssg_5_100_sg-ner\model-best ..\..\datasets\NER\processed\NER_concatinated-test.spacy --output ../../datasets/NER/ssg_5_100_sg-ner.json --gold-preproc
python -m spacy evaluate ..\..\Models\Spacy_tagger\fasttext_5_200_sg-ner\model-best ..\..\datasets\NER\processed\NER_concatinated-test.spacy --output ../../datasets/NER/fasttext_5_200_sg-ner.json --gold-preproc
::python -m spacy evaluate ..\..\Models\Spacy_tagger\word2vec_5_200_sg-ner\model-best ..\..\datasets\NER\processed\NER_concatinated-test.spacy --output ../../datasets/NER/word2vec_5_200_sg-ner.json --gold-preproc
python -m spacy evaluate ..\..\Models\Spacy_tagger\ng2v_5_200_sg-ner\model-best ..\..\datasets\NER\processed\NER_concatinated-test.spacy --output ../../datasets/NER/ng2v_5_200_sg-ner.json --gold-preproc